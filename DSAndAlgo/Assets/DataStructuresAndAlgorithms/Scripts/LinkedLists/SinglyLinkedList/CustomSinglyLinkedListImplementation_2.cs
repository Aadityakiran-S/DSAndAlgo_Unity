...
public class CustomSinglyLinkedListImplementation_2 : MonoBehaviour
{
    #region Referances

    [SerializeField] private CustomSinglyLinkedList2 _linkedList;
    ...
    private void Awake()
    {
        _linkedList = new CustomSinglyLinkedList2("Midhun");
