...
public class MergeSortedArrays : MonoBehaviour
{
    #region References
    ...
    private void Start()
    {
        _mergedArray = Return_MergedArrayFromSortedArrayPair(_array1, _array2);
    }
    ...
    public int[] Return_MergedArrayFromSortedArrayPair(int[] array1, int[] array2)
    {
